...
async function migrate() {
    ...
    await orm.query("CREATE TABLE IF NOT EXISTS "+prefix+"accounts (id INTEGER PRIMARY KEY AUTO_INCREMENT, username VARCHAR(255), password VARCHAR(255), is_active BOOLEAN, created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP)");
    await orm.query("CREATE TABLE IF NOT EXISTS "+prefix+"markets (id INTEGER PRIMARY KEY AUTO_INCREMENT, title VARCHAR(255), status BOOLEAN, transaction_fee FLOAT, created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP)");
    ...
    //await orm.query("CREATE TABLE IF NOT EXISTS "+prefix+"prices (id INTEGER PRIMARY KEY AUTO_INCREMENT, symbol VARCHAR(255), ask FLOAT, bid FLOAT(11), timestamp INTEGER, created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP)");
